#!/usr/bin/env bash
# ==============================================================================
# Script: run_elements_studio_in_container.sh
# Description: Runs or manages Flexiv Elements Studio inside a Docker container.
#
# Features:
...
IMAGE="flexiv-elements-studio:${TAG}"
